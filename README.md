...
- [`@sonim1/preqstation`](https://www.npmjs.com/package/@sonim1/preqstation) — PREQ CLI for operator-host setup, project mapping, health checks, and direct or integration-based dispatch
- [`preqstation-skill`](https://github.com/sonim1/preqstation-skill) — legacy/manual direct-client MCP support for Claude Code, Codex, and Gemini
