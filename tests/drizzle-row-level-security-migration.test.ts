...
const EXPECTED_POLICIES_BY_TABLE = {
  ...
  task_work_nodes: ['task_work_nodes_owner_all'],
  task_work_node_dependencies: ['task_work_node_dependencies_owner_all'],
  task_work_node_events: ['task_work_node_events_owner_all'],
  task_work_node_evidence: ['task_work_node_evidence_owner_all'],
